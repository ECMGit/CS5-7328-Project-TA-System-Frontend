...
const ViewApplicationsByJobID: React.FC = () => {
  ...
  const { taApplications } = location.state as { taApplications: TAApplicationData[] };
        ...
        {taApplications.length > 0 ? (
          <List>
            {taApplications.map((app, index) => (
              <Paper key={index} elevation={2} sx={{ margin: '20px', padding: '20px' }}>
                <ListItem sx={{ border: '1px solid #ccc', borderRadius: '4px', padding: '10px' }}>
                  <ListItemText
                    ...
                    secondary={
                      <>
                        ...
                        <br />
                        <Typography component="span" variant="body2">
                          Resume: <a href={app.resumeFile} target="_blank" rel="noopener noreferrer">View Resume</a>
                        </Typography>
                        <br />
                        <Typography component="span" variant="body2">
                          Status: {app.status}
